...
class PasswordResetOTP(models.Model):
    """One-time code used to authorize a password reset. Kept separate from
    EmailOTP so a pending email-verification code and a pending
    password-reset code never invalidate each other."""
